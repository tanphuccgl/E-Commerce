...
import 'package:e_commerce/src/modules/profile/widgets/header_profile.dart';
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          const Expanded(flex: 3, child: HeaderProfile()),
          Expanded(
            flex: 4,
          ...
          const Expanded(flex: 23, child: ListTileProfile()),
        ],
      ),
    );
  }
